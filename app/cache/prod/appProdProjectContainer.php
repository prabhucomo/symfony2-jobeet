...
class appProdProjectContainer extends Container
{
    ...
    {
        require_once '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/jms_diextra/doctrine/EntityManager_5199fec34f308.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_cfa19658ed69417bbec8297cbafeaf22');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_cfa19658ed69417bbec8297cbafeaf22');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_cfa19658ed69417bbec8297cbafeaf22');
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/home/prabhu/Projects/Symfonyjobeet/src/Ens/JobeetBundle/Resources/config/doctrine' => 'Ens\\JobeetBundle\\Entity'));
        ...
        $f->setProxyDir('/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5199fec34f308_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/prabhu/Projects/Symfonyjobeet/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Ens\\JobeetBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/sessions');
    }
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'Jobeet Admin', 'bundles/sonataadmin/logo_title.png');
        ...
        $instance->setAdminServiceIds(array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job', 2 => 'sonata.media.admin.media', 3 => 'sonata.media.admin.gallery', 4 => 'sonata.media.admin.gallery_has_media'));
        $instance->setAdminGroups(array('jobeet' => array('label' => 'jobeet', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job')), 'sonata_media' => array('label' => 'sonata_media', 'label_catalogue' => 'SonataMediaBundle', 'items' => array(0 => 'sonata.media.admin.media', 1 => 'sonata.media.admin.gallery'))));
        $instance->setAdminClasses(array('Ens\\JobeetBundle\\Entity\\Category' => 'ens.jobeet.admin.category', 'Ens\\JobeetBundle\\Entity\\Job' => 'ens.jobeet.admin.job', 'Application\\Sonata\\MediaBundle\\Entity\\Media' => 'sonata.media.admin.media', 'Application\\Sonata\\MediaBundle\\Entity\\Gallery' => 'sonata.media.admin.gallery', 'Application\\Sonata\\MediaBundle\\Entity\\GalleryHasMedia' => 'sonata.media.admin.gallery_has_media'));
        return $instance;
    }
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job', 2 => 'sonata.media.admin.media', 3 => 'sonata.media.admin.gallery', 4 => 'sonata.media.admin.gallery_has_media'), $this);
    }
    ...
    {
        return $this->services['sonata.media.adapter.filesystem.local'] = new \Sonata\MediaBundle\Filesystem\Local('/home/prabhu/Projects/Symfonyjobeet/app/../web/uploads/media', false);
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/prabhu/Projects/Symfonyjobeet/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod',
            ...
            'session.save_path' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                ...
                1 => '/home/prabhu/Projects/Symfonyjobeet/vendor/sonata-project/media-bundle/Sonata/MediaBundle/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/profiler',
            ...
            'router.resource' => '/home/prabhu/Projects/Symfonyjobeet/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/jms_diextra/doctrine/EntityManager_5199fec34f308.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5199fec34f308_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/home/prabhu/Projects/Symfonyjobeet/app/cache/prod/jms_security',
