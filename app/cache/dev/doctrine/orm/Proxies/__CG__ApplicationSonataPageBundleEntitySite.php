...
class Site extends \Application\Sonata\PageBundle\Entity\Site implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'gacode', 'enabled', 'createdAt', 'updatedAt', 'name', 'host', 'relativePath', 'enabledFrom', 'enabledTo', 'isDefault', 'formats', 'locale', 'title', 'metaKeywords', 'metaDescription');
        }
